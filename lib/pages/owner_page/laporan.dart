...
class LaporanOw extends ConsumerStatefulWidget {
  const LaporanOw({Key? key}) : super(key: key);

  @override
  ConsumerState<LaporanOw> createState() => _LaporanState();
}

class _LaporanState extends ConsumerState<LaporanOw> {
  late Future<List<BahanBaku>> futureBahanBaku;

  @override
  void initState() {
    super.initState();
    futureBahanBaku = BahanBakuClient.getBahanBakuOw();
  }
